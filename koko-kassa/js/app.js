...
function displayPics() {
  ...
  // COMMENT:It didn't work because var is a global variable and const is a local variable
  console.log(viewed);
...
function showList() {
  for(let i = 0; i < allProducts.length; i++) {
    ...
    liEl.textContent = (`${event.target.id} has ${allProducts[i].votes} votes in ${allProducts[i].views} views`);
